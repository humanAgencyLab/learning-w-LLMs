      ...
      <div className="consent-container">
        ...
        <div className="consent-content">
          ...
          <div className="consent-section">
            ...
            <p>
              We are studying how AI tutoring systems can help people learn new skills 
              through self-regulated learning (SRL). You will use an AI tutor to learn 
              a topic of your choice (Python programming, Piano, or Guitar) for about 45 minutes.
            </p>
          </div>
          ...
          <div className="consent-section">
            ...
            <ul>
              ...
              <li>Complete a post-assessment and feedback survey (10 minutes)</li>
            </ul>
          </div>
          ...
          <div className="consent-section">
            ...
            <p>
              We will collect your learning progress, quiz scores, and feedback responses. 
              Your Prolific ID will be used to link your data but will be anonymized in analysis.
            </p>
          </div>
          ...
          <div className="consent-section">
            ...
            <p>
              This study takes approximately 45 minutes. You will be compensated according 
              to Prolific's standard rates for studies of this duration.
            </p>
          </div>
